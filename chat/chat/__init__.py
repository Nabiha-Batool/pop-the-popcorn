...
def main(global_config, **settings):
    ...
    config.add_tween('chat.auth.authenticator')
    ...
    config.add_route('invihome', '/invihome')
    ...
    add_admin_handler(config, DBSession, get_models(chat), 'admin.', '/admin', AdminController)
...
def configure_app_routes(config):
    ...
    for app_name in enabled_apps:
        ...
        app_module = importlib.import_module(".apps.%s" % app_name, "chat")
